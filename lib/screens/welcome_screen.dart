...
import 'package:flashchat/screens/regestration_screen.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RoundedButton(colour: Colors.lightBlueAccent,title: 'Login',
              route: (){Navigator.pushNamed(context, LoginScreen.id);} ,),
            RoundedButton(colour: Colors.blueAccent,title: 'Register',
              route: (){Navigator.pushNamed(context, RegistrationScreen.id);},),
          ],
        ),
      ),
    );
